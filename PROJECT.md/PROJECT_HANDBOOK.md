...
# Actualización normativa — versión 2.1

Estado: Vigente
Última actualización: julio de 2026

Esta actualización forma parte del Manual oficial y prevalece sobre cualquier regla anterior del mismo documento que resulte incompatible.

## Jerarquía documental

1. Las decisiones explícitas de la administradora definen la dirección del producto.
2. `AGENTS.md` contiene las restricciones obligatorias para cualquier IA.
3. Este Manual es la referencia operativa principal.
4. `PROJECT_VISION.md`, `DESIGN_PRINCIPLES.md`, `DESIGN_SYSTEM.md` y `UX_PRINCIPLES.md` desarrollan sus respectivas áreas.
5. `PROJECT_STATUS.md` y `ROADMAP.md` registran el estado y las prioridades vigentes.
6. `LEGACY_NOTES.md` es únicamente un archivo histórico. Sus propuestas no se consideran aprobadas y no pueden prevalecer sobre documentos vigentes.

Cuando exista una contradicción, debe señalarse y resolverse en la documentación antes de modificar el producto. No se asumirá automáticamente que la versión más extensa o más antigua es la correcta.

## Tamaño y división de componentes

El número de líneas es una señal de revisión, no una medida automática de calidad.

- Entre 250 y 300 líneas: revisar la responsabilidad y la complejidad del archivo.
- Por encima de 400 líneas: justificar por qué debe permanecer unido o dividirlo cuando existan bloques independientes claros.
- Ningún archivo se dividirá únicamente para cumplir un límite numérico.

La división es necesaria cuando se cumple uno o varios de estos criterios:

- mezcla responsabilidades no relacionadas;
- duplica lógica o interfaz existente;
- contiene estado que afecta a bloques independientes;
- dificulta probar o modificar una parte de forma aislada;
- incluye bloques que pueden funcionar mediante propiedades claras;
- la extracción mejora de forma demostrable la legibilidad o la reutilización.

No se dividirá cuando la extracción:

- cree archivos sin una responsabilidad propia;
- aumente innecesariamente el paso de propiedades;
- oculte el flujo principal;
- empeore la comprensión o el mantenimiento.

La regla anterior «más de 300 líneas: revisar; más de 400 líneas: dividir obligatoriamente» queda sustituida por estos criterios.
